# Цена колл опциона Европейского типа методом Монте‑Карло

Требуется оценить цену колла опциона Европейского типа методом **Монте‑Карло** и показать корректность реализации.
...
В реализации основной эксперимент использует точную выборку $S_T$ при логнормальном законе (эквивалентно сильному решению GBM, без ошибки дискретизации по времени):
